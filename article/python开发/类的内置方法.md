...
Python的Class机制内置了很多特殊的方法来帮助使用者高度定制自己的类，这些内置方法都是以双下划线开头和结尾的，会在满足某种条件时自动触发，我们以常用的\__str__和\__del__为例来简单介绍它们的使用。
...
[更多](https://www.cnblogs.com/linhaifeng/articles/6204014.html)
