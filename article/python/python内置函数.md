...
#dir(obj) 查看对象存在哪些属性 ,能够用'.'调用出哪些属性
class Foo:
    pass
...
# eval 执行字符串中的表达式
print(eval('1+3'),type(eval('1+3')))
print(eval("{'a':1}"),type(eval("{'a':1}")))
# 4 <class 'int'>
# {'a': 1} <class 'dict'>
...
#zip 拉链函数
v1 = 'hello'
v2 = [111,222,333,444,555,6666]
res=zip(v1,v2)
print(res)
# <zip object at 0x03AC1D88>
print(list(res))
# [('h', 111), ('e', 222), ('l', 333), ('l', 444), ('o', 555)]
